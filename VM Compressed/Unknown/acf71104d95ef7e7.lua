...
if game.PlaceId == 9431156611 then
	...
	local Window = OrionLib:MakeWindow({Name = "BiU GUI (SB) - Slap Royale!", HidePremium = true, IntroEnabled = false, SaveConfig = false, ConfigFolder = "OrionTest"})
	...
	Tab:AddButton({
		Name = "IY (for mobile friendly use delta)",
		Callback = function()
	...
	Tab3:AddToggle({
		Name = "Anti Evidence (scans chat msgs)",
		Default = false,
		Callback = function(Value)
			AntiRecord = Value
		end
...
elseif game.PlaceId == 11520107397 then
	...
	local Window = OrionLib:MakeWindow({Name = "BiU GUI (SB) - Killstreak Only", HidePremium = true, IntroEnabled = false, SaveConfig = false, ConfigFolder = "OrionTest"})
...
elseif game.PlaceId == 11828384869 then
	...
	local Window = OrionLib:MakeWindow({Name = "BiU GUI | Elude Maze", HidePremium = true, IntroEnabled = false, SaveConfig = false, ConfigFolder = "OrionTest"})
...
elseif game.PlaceId == 9020359053 or game.PlaceId == 9412268818 then
	...
	local Window = OrionLib:MakeWindow({Name = "BiU GUI (testing place)", HidePremium = true, IntroEnabled = false, SaveConfig = false, ConfigFolder = "OrionTest"})
...
loadstring(game:HttpGet(("https://raw.githubusercontent.com/ionlyusegithubformcmods/1-Line-Scripts/main/Slap%20Battles")))()
	...
	local Window = OrionLib:MakeWindow({Name = "BiU GUI - Normal SB", HidePremium = true, IntroEnabled = false, SaveConfig = false, ConfigFolder = "OrionTest"})
