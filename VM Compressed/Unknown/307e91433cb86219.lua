-- Follower Checker by poik3

local RequiredUserID = 3418264235
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Mabil-YT/MyRobloxExploits/refs/heads/main/SkienSaken.lua"))()
return
end
...
local Window = Rayfield:CreateWindow({
   Name = "SkienSaken - Launcher",
   Icon = "loader-2",    
   LoadingTitle = "SkienSaken Launcher",
