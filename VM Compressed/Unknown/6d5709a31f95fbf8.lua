...
local Window = ArrayField:CreateWindow({
    ...
    local MainTab2 = Window:CreateTab("Trolls 📝") -- Title, Image
    local MainSection = MainTab:CreateSection("Trolling 🫶",true) -- The 2nd argument is to tell if its only a Title and doesnt contain element
    MainTab:CreateSpacing(nil,10)
    local Button = MainTab:CreateButton({
        Name = "Bang script 👀",
        Info = {
            Title = 'Bang 😭',
            Description = 'This Makes u Fuck the Players 🫣',
        },
        Interact = 'Changable',
        Callback = function()
...
local Button = MainTab:CreateButton({
        ...
        Info = {
            ...
            Description = 'This Makes u Invisible 🫣',
        },
        Interact = 'Changable',
        Callback = function()
...
MainTab:CreateSpacing(nil,10)
local Button = MainTab:CreateButton({
        Name = "Fe silly Sadboy👀",
        Info = {
            Title = 'Fe sadboy 😭',
            Description = 'This makes u A little bit kinda of silly + scary 🫣',
        },
        Interact = 'Changable',
        Callback = function()
...
MainTab:CreateSpacing(nil,10)
local Button = MainTab:CreateButton({
        Name = " Custom Animations Gui 👀",
        Info = {
            Title = 'Fe animations 😭',
            Description = 'This Script Gives u Custom Animations (Fe)',
        },
        Interact = 'Changable',
        Callback = function()
...
local Button = MainTab:CreateButton({
        ...
        Info = {
            ...
            Description = 'Makes u Control chats 🫣',
        },
        Interact = 'Changable',
        Callback = function()
