...
local S={
"abysseye.luau","blight.luau","blockcar.luau","caducus.luau","burgerblood.luau","banhammer.luau","chara.luau","copv2.luau","eyozen.luau",
"galefighter.luau","goner.luau","losthope.luau","masterofelement.luau","nightmaresans.luau","pillow.luau","reaper.luau","sans.luau",
"sanslastbreath.luau","serveradmin.luau","warden.luau"
}

local g=Instance.new("ScreenGui",p.PlayerGui)
g.Name="classical hub"
