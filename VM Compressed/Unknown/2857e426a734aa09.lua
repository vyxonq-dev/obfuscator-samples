...
local Button = Tab:CreateButton({
   ...
   Callback = function()local args = {
	...
	workspace:WaitForChild("Base1"):WaitForChild("PlacedPieces"):WaitForChild("Seller"),	500000000000
...
local Button = Tab:CreateButton({
   ...
   Callback = function()local args = {
	...
	workspace:WaitForChild("Base2"):WaitForChild("PlacedPieces"):WaitForChild("Seller"),
