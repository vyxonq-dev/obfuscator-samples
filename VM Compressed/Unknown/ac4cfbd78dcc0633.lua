--[Leaking Hubs Leakers and Skidders]
--[KITK4T IS TRASH LEAKER 🐒👋🎩]
...
local function fireEvent(event, ...)
    if event then
        ...
        warn("Event Not Found:", event)
    end
end

fireEvent(NameTextEvent, "RolePlayName", "[Usuário do Hub Renegado]")

fireEvent(NameColorEvent, "PickingRPNameColor", Color3.new(255, 0, 0))

-- Bio de RolePlay
fireEvent(NameTextEvent, "RolePlayBio", "lkzin developer")

fireEvent(NameColorEvent, "PickingRPBioColor", Color3.fromRGB(0, 0, 0))

local Libary = loadstring(game:HttpGet("https://pastefy.app/qoLIvWvg/raw"))()

local Window = Libary:MakeWindow({
    Title = "Renegado hub| Brookhaven RP 🏡",
    SubTitle = "by: lkzin",
    LoadText = "Carregando Renegado",
    Flags = "Renegadohub_Broookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://70484094709190", BackgroundTransparency = 0 },
    Corner = { CornerRadius = UDim.new(35, 1) },
})

local InfoTab = Window:MakeTab({ Title = "Informations", Icon = "rbxassetid://10723415903" })

InfoTab:AddSection({ "Credits" })

InfoTab:AddParagraph({ "Team:", "Renegado hub Team" })

InfoTab:AddParagraph({ "Programers:", "lkzin and renegado" })


InfoTab:AddSection({ "Internet Things" })

InfoTab:AddDiscordInvite({
    Name = "Renegado Hub | Christmas",
    Description = "Stay Up to Date With all the news from our Hub",
    Logo = "rbxassetid://70484094709190",
    Invite = "https://discord.gg/x5sZkvaKt",
})
...
InfoTab:AddParagraph({ "Your Language", "English" })

InfoTab:AddParagraph({ "You Using", "Renegado Hub" })

InfoTab:AddParagraph({ "Hub Version", "Version v5" })

InfoTab:AddSection({ "Reintrar" })
InfoTab:AddButton({
    Name = "Reintrar",
    Callback = function()
...
local autoTab = Window:MakeTab({ Title = "Events", Icon = "rbxassetid://10734983868" })


autoTab:AddSection({ "Events" })

autoTab:AddParagraph({"The Renegado is Losers Fuckeds"})

local BrowserTab = Window:MakeTab({ "Browser", "Wi-fi" })

BrowserTab:AddButton({
    Name = "Browser by Renegado Tem --Fucked Browser",
    Callback = function()
...
TrollTab:AddSection({ "SkyBox [ by lkzin]" })

TrollTab:AddButton({

    Name = "SkyBox [ by lkzin]",
...
local ToolsTab = Window:MakeTab({"Items [ Update! ]", "backpack"})
...
local kitTab = Window:MakeTab({"Protections", "rbxassetid://11322093465"})
