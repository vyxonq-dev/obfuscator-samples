...
local window = DrRayLibrary:Load("Neon.C Hub V5", "Default")

local tab = DrRayLibrary.newTab("🎯 Combat", "Default")

tab.newButton("Auto Parry V5", "Auto Parry", function()
...
tab.newButton("Auto Win V5", "Win every game easily!", function()
    getgenv().god = true
...
tab.newButton("Auto Spam V3", "Spams automatically for you in a clash!", function() loadstring(game:HttpGet("https://raw.githubusercontent.com/Code4Zaaa/X7Project/main/Game/AutoParryOnly"))();
end)
...
tab.newButton("Thanks for using the Neon.C Hub V5!", "Script made by Neoncat", function()
    print('Hello!')
end)
