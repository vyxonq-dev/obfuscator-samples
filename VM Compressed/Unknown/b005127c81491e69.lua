...
local function setClipboardWithURL()
    setclipboard("https://link-hub.net/1345806/TccANbFeTopb")
end
...
local function enterKey()
    ...
    if userInputKey == correctKey then
        local scriptURL = "loadstring(game:HttpGet("https://raw.githubusercontent.com/showsix/rivals/refs/heads/main/script"))()"
