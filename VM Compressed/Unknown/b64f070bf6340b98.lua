...
do -- Example UI
	local Window = library:AddWindow("Furk - Project Slayers", {
		main_color = Color3.fromRGB(0, 0, 0),
		min_size = Vector2.new(280, 270),
		toggle_key = Enum.KeyCode.RightShift,
		can_resize = true,
	})
	...
	do -- Elements
		...
		Tab:AddButton("#1 - Lazy Hub", function()
		...
		Tab:AddButton("Spotify Hub", function()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/ewyzu/ewyzu-scripts/main/Project-Slayers"))()
		end)
		Tab:AddButton("KeybrewHub", function()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/borntodiekuv/KeybrewHub/main/Main"))()
		end)
		Tab:AddButton("NEW - Semi-fast LEVEL FARM", function()
			loadstring(game:HttpGet("https://pastebin.com/raw/SinWu00m"))()
		end)
		Tab:AddButton("LeadMarker Hub", function()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/LeadMarker/Scripts/main/ProjectSlayer.lua"))()
		end)
		Tab:AddButton("Trap Hub", function()
	...
	local Tab = Window:AddTab("Side")

	do -- Elements
		Tab:AddLabel("Thanks For Using Furk Ultra")

		
		Tab:AddButton("Auto Spin 0.1% Clan (NOT INF SPINS)", function()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/noRynx/miningsim/main/slayerspins"))()
		end)
		Tab:AddButton("Muzan ESP + Serverhop", function()
