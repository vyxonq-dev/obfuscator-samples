-- Krystal Dance V3, Made by Hemi, fixed by FEScriptzzBOI (ts was tuff to fix)
...
pcall(function()
    ...
    OxideApi.Notification('Krystal Dance V3, Made by Hemi, Archived by FEScriptzzBOI', 15)
end)
