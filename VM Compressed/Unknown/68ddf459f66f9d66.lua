...
function MakeScriptHub()
         loadstring(game:HttpGet('https://raw.githubusercontent.com/Alexcirer/Alexcirer/main/Qf'))() --Put The Script That Will Load If The Key Is Correct Here
end
...
Tab:AddButton({
	Name = "Copy Key",
	Callback = function()
      		setclipboard("https://gateway.platoboost.com/l/57003/Get_Key") --This Will Copy The Link Of The Key
  	end    
}) 
