--[[     Combined Oxide Reanimation + Krystal Dance v3 ]]
local player = game.Players.LocalPlayer

repeat wait() until player.Character and player.Character:FindFirstChild("HumanoidRootPart")
wait(1)

local safePos = CFrame.new(0, 10, 0)
if workspace:FindFirstChild("SpawnLocation") then
    safePos = workspace.SpawnLocation.CFrame + Vector3.new(0, 5, 0)
elseif player.Character.HumanoidRootPart then
    safePos = player.Character.HumanoidRootPart.CFrame
end

local positionMonitor = game:GetService("RunService").Heartbeat:Connect(function()
...
local sprintanim = is:LoadLocalAsset('rbxassetid://73688515498572')
    ...
    elseif mode == 3 then
        ...
        elseif k == 'r' then
            if dancing == false then
                ...
                timeposcur = sound69.TimePosition
                sound69:Play()
                playanim(77920672554221, 1, true, nil, false)
            else
                stopanim()
            end
        elseif k == 't' then
        ...
        elseif k == 'c' then
            if dancing == false then
                ...
                timeposcur = sound69.TimePosition
                sound69:Play()
                playanim(109167288749488, 0.35, true, nil, false)
            else
                stopanim()
            end
        elseif k == 'v' then
...
game:GetService("StarterGui"):SetCore("SendNotification", { 
    Title = "Info";
    Text = "Krystal Dance V3 Hat reanimation made by Idk!";
    Duration = 5;
})