...
Sakura.Appearance = {
    Title = "Crown Softworks",
    Subtitle = "Get A Free Key",
    Tagline = "Join our discord!",
    Icon = "rbxassetid://116255434488074",
    IconSize = UDim2.fromOffset(30, 30),
}

Sakura.Links.Discord = "discord.gg/RURAwrWDuC"
Sakura.Storage.FileName = "CrownKey"
