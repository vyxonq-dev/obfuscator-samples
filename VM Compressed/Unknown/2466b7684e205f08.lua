--- You are Pedophile Skid

local kavoUi = loadstring(game:HttpGet("https://pastebin.com/raw/vff1bQ9F"))()
local window = kavoUi.CreateLib("Kat Killer By JN HH Gaming","BloodTheme")
...
Tab1Section:NewButton("Aimbot/Hitbox/Silent Aim","Increase Range",function()
...
Tab1Section:NewToggle("Esp Box","Opens Box esp",function()
...
Tab1Section:NewToggle("Tracers","Opens Tracers",function()
...
local Tab1Section = Tab1:NewSection("No Useless Buttons Like Other Scripts")
