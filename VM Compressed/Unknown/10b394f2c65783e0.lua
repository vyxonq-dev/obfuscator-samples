-- KOUMALA HUB | TAXI BOSS
-- Fixed Fluent UI Version
...
Tabs.Farm:AddParagraph({
    ...
    Content = "Automatically collect items and destroy pumpkins"
})

local AutoPumpkin = Tabs.Farm:AddToggle("AutoPumpkin", {
...
local AutoParts = Tabs.Farm:AddToggle("AutoParts", {
...
print("✅ Koumala Hub fully loaded!")