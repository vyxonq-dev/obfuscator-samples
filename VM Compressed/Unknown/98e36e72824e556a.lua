...
_2.Text = "2. Reanimate Golden Freddy"
_2.TextColor3 = Color3.fromRGB(231, 231, 231)
_2.TextSize = 14.000
_2.MouseButton1Down:connect(function()
	loadstring(game:HttpGet("https://pastebin.com/raw/jgsbctep"))()
end)
...
info.Size = UDim2.new(0, 221, 0, 74)
info.Font = Enum.Font.SourceSans
info.Text = "Use any roblox emote, press anim remover and then press reanimate Golden Freddy! Emote Animation Credits: @Tilted Tree Studios, @NotReal_Darlin, @sirensinthecemetery, @DreynTime."
...
title.Size = UDim2.new(0, 155, 0, 19)
title.Font = Enum.Font.Michroma
title.Text = "Fe Golden Freddy - V1"
title.TextColor3 = Color3.fromRGB(255, 184, 19)
...
local function BVXTKXA_fake_script() -- topbar.Dragify 
...
coroutine.wrap(BVXTKXA_fake_script)()
local function UWOTI_fake_script() -- close.LocalScript 
...
coroutine.wrap(UWOTI_fake_script)()
