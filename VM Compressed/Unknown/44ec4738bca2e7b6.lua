...
local Window = Rayfield:CreateWindow({
   Name = "#Rust.gg",
   Icon = 70752959395218, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).
   LoadingTitle = "Welcome, Son Of God.",
   LoadingSubtitle = "by Dynch1ka",
   ShowText = "rust", -- for mobile users to unhide rayfield, change if you'd like
...
local AimTab = Window:CreateTab("Combat", 4483362458) -- Title, Image
...
local WallTab = Window:CreateTab("WallHack", 4483362458) -- Title, Image

local WallButton = WallTab:CreateButton({
   Name = "WallHack",
   Callback = function()
...
local Build1Button = MiscTab:CreateButton({
   Name = "Enable Build GUI",
   Callback = function()
	playergui.BuildGUI.Enabled = true
   end,
})

local Build2Button = MiscTab:CreateButton({
   Name = "Disable Build GUI",
   Callback = function()
	playergui.BuildGUI.Enabled = false
   end,
})

local Hammer1Button = MiscTab:CreateButton({
   Name = "Enable Hammer GUI",
   Callback = function()
	playergui.HammerGUI.Enabled = true
   end,
})

local Hammer2Button = MiscTab:CreateButton({
   Name = "Disable Hammer GUI",
   Callback = function()
	playergui.HammerGUI.Enabled = false
   end,
})

local Jump1Button = MiscTab:CreateButton({
   Name = "Disable JumpCooldown",
   Callback = function()
	playergui.JumpCooldown.Disabled = true
   end,
})

local Jump2Button = MiscTab:CreateButton({
   Name = "Enable JumpCooldown",
   Callback = function()
	playergui.JumpCooldown.Enabled = true 
   end,
})

local AntiButton = MiscTab:CreateButton({
   Name = "Disable AntiCheat",
   Callback = function()
	playerscripts.LocalScript2.Disabled = true
   end,
})
