...
if game.PlaceId ~= 13864667823 then
	...
	-- INFO (Lobby)
		...
		local Window = OrionLib:MakeWindow({
			...
			Name = "KRT Hub | Break in 1.0.1 (Lobby)",
...
Tab:AddButton({
    ...
    Callback = function()
        ...
        if clipboard then
            ...
            clipboard("https://t.me/KRT_client")

            game:GetService("StarterGui"):SetCore("SendNotification", {

                Title = "Ссылка скопирована",

                Text = "Ссылка на Telegram скопирована в буфер обмена",
...
-- Tables
	...
	local Window = OrionLib:MakeWindow({
		...
		Name = "KRT Hub | Break in 1.0.1 (Play)",
	...
	Notify('Loaded!', "Script credits:\nKRT Hub", 'rbxassetid://4483345998', 15)
