...
local win = UILib:Window("KNZ HUB",Color3.fromRGB(44, 120, 224), Enum.KeyCode.RightControl)
...
Settings:Button("Copy Discord Invite", function()
    setclipboard("https://discord.gg/RZn9sppexj")
    UILib:Notification("Notification", "Copied!", "Okay")
	Settings:Label("made by Yallto_weak")
end)
