...
Sakura.Links.Discord = "discord.gg/3RfqUMajFT"
Sakura.Storage.FileName = "R_LW"
...
Sakura.Shop = {
    ...
    ButtonText = "Buy",
    Link = "https://catking.mysellauth.com/products"
}
