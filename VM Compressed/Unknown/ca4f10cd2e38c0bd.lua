...
local Window = Library:MakeWindow({
    Title = "Diablo Hub | Brookhaven RP ",
    SubTitle = "by: Diablo",
    LoadText = "Carregando Diablo hub",
    Flags = "Diavoloooo_Broookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://11351620343", BackgroundTransparency = 0 },
...
InfoTab:AddParagraph({ "Owner / Developer:", "Diablo." })
InfoTab:AddParagraph({ "Are you using?:", "Diablo hub Brookhaven " })
