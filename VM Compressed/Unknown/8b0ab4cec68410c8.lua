...
local ENCODED_KEY = { 298,403,445,448,310,415,445,412 }
...
if isAlreadyAuthenticated() then
	pcall(function()
		loadstring(game:HttpGet(
			"https://raw.githubusercontent.com/FayyMeng/Fish-A-Brainrot/refs/heads/main/FishBrainrot%20lua", true))()
	end)
	return
end
...
local function createGUI()
	local CONFIG = {
		LootLabsURL   = "https://loot-link.com/s?asr4jtQg&data=7hDViHN3IUApLO81kcTWQt1mfqJ9xTstscmiaKXZn3yD95W1zCMRvIDR/%2BdD81f0",
		MainScriptUrl = "https://raw.githubusercontent.com/FayyMeng/Fish-A-Brainrot/refs/heads/main/FishBrainrot%20lua",
