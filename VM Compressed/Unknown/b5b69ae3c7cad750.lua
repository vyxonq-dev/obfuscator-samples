...
game.ReplicatedStorage["01_server"]:FireServer("cmd", "-gh 9350274205, 9350274205, 4753437569")
wait(2.6)
...
game.Players.LocalPlayer.Character["VANS_Umb"].Handle.Mesh:Destroy()
game.Players.LocalPlayer.Character["VANS_Umb"].Handle.AccessoryWeld:Destroy()
...
while true do
    ...
    --right hand
    plr["VANS_Umb"].Handle.Position = plr["Right Leg"].Position + Vector3.new(0,0,0)
    plr["VANS_Umb"].Handle.Orientation = plr["Right Leg"].Orientation
    ...
    plr["VANS_Umb"].Handle.Velocity = Vector3.new(20,0,20)
