...
local function setClipboardWithURL()
    setclipboard("https://linkvertise.com/1345806/key-system?o=sharing")
end
...
local function enterKey()
    ...
    local correctKey = "KEY-2025"

    if userInputKey == correctKey then
        local scriptURL = "https://raw.githubusercontent.com/DarkClpher/RBX-Scripts/refs/heads/main/Ink%20Game/Main.luau"
