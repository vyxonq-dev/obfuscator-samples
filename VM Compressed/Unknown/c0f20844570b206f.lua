...
Junkie.service = "Velox Hub"
Junkie.identifier = "1128037"
Junkie.provider = "Velox Hub"
...
local result = (function()
    ...
    function UI.new(options)
        ...
        self.title = self.options.title or "Velox Hub"
        self.subtitle = self.options.subtitle or "by Ovei"
