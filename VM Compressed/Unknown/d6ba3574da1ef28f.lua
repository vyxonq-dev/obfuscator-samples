...
local TogglePlayers = MainTab:CreateToggle({
    ...
    Callback = function(Value)
        ...
        local PRICE_TABLE = {
            ...
            ["Shark Tooth"] = 60, ["Diamond"] = 310,
            ["Live Eye"] = 600, ["Alive Eye"] = 600,
            ["Baking pan"] = 60,
            ["Painting of a Mysterious Man"] = 45,
            ["Painting of Mysterious Man"] = 45,
            ["Mysterious Man Painting"] = 45,
        }
...
local AimLabel = MiscTab:CreateLabel(
    "Aimbot works only against players",
    nil,
    Color3.fromRGB(255, 200, 100),
    false
)
