...
createButton("GOD MODE (WORKS ON SOME OBBIES)", 40, function()
    loadstring(game:HttpGet("https://pastefy.app/LeT0LObc/raw"))()
end)
...
bottomTextLabel.Text = "made by robo"  -- Footer text
