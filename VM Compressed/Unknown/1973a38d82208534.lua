if not game:IsLoaded()then game.Loaded:Wait()end;do ("JNKIE Game Loader - Unauthorized tampering or debugging of protected scripts is strictly prohibited and may result in a global blacklist from JNKIE protected scripts."):sub(1,1);local S,P,G={"309a3f1b0a4e0d3d6c9b6f65786211d36342445e5a22e1f82c330f375c9bf6c2"},{[18879239467]=1},{};local i=P[game.PlaceId]or G[game.GameId];if not i then warn("Unsupported game [LDR-NOMAP]");return end;local Junkie = loadstring(game:HttpGet("https://jnkie.com/sdk/library.lua"))()
Junkie.service = "berkutlab"
Junkie.identifier = "1185522"
Junkie.provider = "JC Loader Keys"
