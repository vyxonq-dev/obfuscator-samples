...
local Window = OrionLib:MakeWindow({Name = "[PHPâ­] C9 Hub", HidePremium = false, SaveConfig = false, IntroEnabled = true, IntroText = "[ð] Welcome to C9 Hub!", IntroIconDisabled = true,  IntroIcon = ""})
