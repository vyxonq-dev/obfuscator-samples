...
local Window = Libary:MakeWindow({
    Title = "FAELZIN HUB",
    SubTitle = "FAELZIN",
    LoadText = "FAELZIN HUB",
    Flags = "faelhub_Broookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://15733579017", BackgroundTransparency = 0 },
    Corner = { CornerRadius = UDim.new(35, 1) },
})

local InfoTab = Window:MakeTab({ Title = "Info", Icon = "rbxassetid://76311199408449" })



InfoTab:AddSection({ "Informações do Script" })
InfoTab:AddParagraph({ "Owner / Developer:", "FAELZIN7" })
InfoTab:AddParagraph({ "Colaborações:", "FAELZIN FEZ SOZINHO BOY " })
InfoTab:AddParagraph({ "Você está usando:", "FAELZIN Hub" })
InfoTab:AddParagraph({"USA COM MODERAÇÃO SAFADA"})
InfoTab:AddParagraph({"Novidades:", "Lag com ônibus já está disponível!"})
InfoTab:AddButton({"VERSÃO EDIT, TA EM BETA", function()
...
-- FunÃ§Ã£o para obter os  dos jogadores
...
local Tab = Window:MakeTab({"PLAYER", "Paper"})
...
local SectionNames = Tab:AddSection({
    Name = "Adicionar nick no Jogador"
})
