...
local Window = Libary:MakeWindow({
    ...
    SubTitle = "by: @xdplatin",
    LoadText = "chaos hub by @xdplatin enjoy",
...
InfoTab:AddSection({ "Informações do Script @xdplatin" })
InfoTab:AddParagraph({ "Owner / Developer:", "@xdplatin" })
