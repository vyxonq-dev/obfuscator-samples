...
frame.Size = UDim2.new(0, 200, 0, 165)  -- Width: 200px, Height: 400px
...
textLabel.Text = "👁️ DOORS TESTING 👁️"
...
createButton("TELEPORT TO END", 40, function()
    loadstring(game:HttpGet("https://pastefy.app/yCPAkaS7/raw"))()
end)
