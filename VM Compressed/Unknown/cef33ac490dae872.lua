...
local Window = Libary:MakeWindow({
    Title = "Shelby Hub| Brookhaven RP ",
    SubTitle = "by: ShelbyDevx ",
    LoadText = "Loading Shelby Hub",
    Flags = "Shelby"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://101273141086757", BackgroundTransparency = 0 },
    Corner = { CornerRadius = UDim.new(35, 1) },
})

local InfoTab = Window:MakeTab({ Title = "Info", Icon = "rbxassetid://101273141086757" })



InfoTab:AddSection({ "Script Information" })
InfoTab:AddParagraph({ "Owner / Developer:", "ShelbyDevx." })
InfoTab:AddParagraph({ "Collaborations:", "Blue, sukuna, Magekko, fx client hub, Star, Toddy" })
InfoTab:AddParagraph({ "You are using:", "Shelby Hub Brookhaven " })
