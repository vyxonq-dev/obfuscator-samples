--[[ co0lkid hub Portugues 🇧🇷 ]]
local Libary = loadstring(game:HttpGet("https://raw.githubusercontent.com/silvaahub/Kkkkkkkkkkkkkkkkkkuuuuuuu/refs/heads/main/raw%20(3)%20(1).txt"))()
workspace.FallenPartsDestroyHeight = -math.huge

local Window = Libary:MakeWindow({
    Title = " CO0LKID HUB| Brookhaven RP 🏡",
    SubTitle = "by:   lkzin",
    LoadText = "Carregando co0lkid hub",
    Flags = "co0lkid_Broookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://134099499968949", BackgroundTransparency = 0 },
...
InfoTab:AddDiscordInvite({
    ...
    Logo = "rbxassetid://134099499968949",
    Invite = "https://discord.gg/aeVyS8DQz",
}) 
InfoTab:AddSection({ "Informações do Script" })
InfoTab:AddParagraph({ "Proprietário / Desenvolvedor:", "silvadevx & lkzin " })
InfoTab:AddParagraph({ "Collaborations:", "silvadevx, night team, CO0LKID team" }) 
InfoTab:AddParagraph({ "Obsfucador:", "??" })
InfoTab:AddParagraph({ "Segurança:", "Silvadev" })
InfoTab:AddParagraph({ "Você está usando:", "co0lkid hub Brookhaven " })
