...
local Games = {
    [89469502395769] = {
        ...
        Script   = "https://chronoshubkb.chronic817.workers.dev/script/kickaluckyblock?t=1629647a63f01f4aaad64c3a846987fa",
        Title    = "ChronosHUB",
        Subtitle = "Kick a Lucky Block",
        Welcome  = "Welcome, " .. game.Players.LocalPlayer.DisplayName .. "!",
        Debug    = false,

        -- Optional: 1 = default speed Â· 0.5 = twice as fast Â· 2 = half speed
        AnimSpeed   = 1,
    ...
    [107646426076756] = {
        ...
        Script   = "https://chronoshubkb.chronic817.workers.dev/script/buildaringfarm?t=1629647a63f01f4aaad64c3a846987fa",
        Title    = "ChronosHUB",
    ...
    [107095834793267] = {
        Name     = "Oil Empire",
        Script   = "https://chronoshubkb.chronic817.workers.dev/script/oil-empire?t=1629647a63f01f4aaad64c3a846987fa",
        Title    = "ChronosHUB",
        Subtitle = "Oil Empire",
        Welcome  = "Welcome, " .. game.Players.LocalPlayer.DisplayName .. "!",
        Debug    = false,
    ...
    [92416421522960] = {
        Name     = "Slime RNG",
        Script   = "https://chronoshubkb.chronic817.workers.dev/script/slimerng?t=1629647a63f01f4aaad64c3a846987fa",
        Title    = "ChronosHUB",
        Subtitle = "Slime RNG",
        Welcome  = "Welcome, " .. game.Players.LocalPlayer.DisplayName .. "!",
        Debug    = false,
