...
for count = 0, 9 do
    if string.find(script_key, tostring(count)) then
        StarterGui:SetCore("SendNotification", {
            ...
            Text = "Your key is outdated! Please see #prem-anc and migrate your key",
            Duration = 30,
            Button1 = "Okay",
        })
        break
